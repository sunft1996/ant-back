...
import styles from './ForgotPwd.less';
...
class Register extends Component {
  ...
  componentDidUpdate() {
    ...
    const account = form.getFieldValue('loginName');
  ...
  handleSubmit = e => {
    ...
    form.validateFields({ force: true }, (err, values) => {
      const { loginName, checkCode, mobile } = values;
      const passWord = this.handleEncrypt(values.password);
      const newPassWord = this.handleEncrypt(values.password);
      if (!err) {
      ...
      <div className={styles.main}>
        ...
        <Form onSubmit={this.handleSubmit}>
          <FormItem>
            ...
            })(<Input size="large" placeholder="请填入用户名" />)}
          </FormItem>
          <FormItem help={help}>
            <Popover
